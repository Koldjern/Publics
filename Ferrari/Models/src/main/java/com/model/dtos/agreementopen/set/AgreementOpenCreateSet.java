...
public class AgreementOpenCreateSet {
    ...
    public AgreementOpenCreateSet(){

    }
    public AgreementOpenCreateSet(int fixedTerms, double startValue, Date startAgreement, String rki, int customerId, int employeeId, int vehicleId, double totalRate) {
