...
public class InvoiceCreateSet {
    ...
    public InvoiceCreateSet(int number, Date dateStart, Date dateEnd, double plus, double minus, double ultimoValue, double primoValue, double payed, String details) {
        this.number = number;
